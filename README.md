 ...
 ensure that pull requests are added in the correct columns, write a code in C, update the web page https://csci3251-2020.github.io/project-team-m/, and lastly promote our repo </p>
 <h1>Code</h1>
 <h1>Contributors</h1>
